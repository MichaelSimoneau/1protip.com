...
- New directive (2025-12-12): Add a hosting rewrite in `firebase.json` mapping `/logo.png` to `/assets/images/icon.png`. Manually copied `apps/1protip.com/assets/images/icon.png` to `apps/1protip.com/public/assets/images/icon.png` to ensure it exists in the web build output and the rewrite target is valid.
